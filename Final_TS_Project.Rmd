...
season = artrans.wge(diff, phi.tr = 52) # ASE 3.82882e+12 | Visually This looks better
```
...
#options(scipen = 999)  # Disable scientific notation globally
print(diff_ase)      # Print result in full decimal format
```
...
#options(scipen = 999)  # Disable scientific notation globally
print(season_ase)      # Print result in full decimal format
```
